...
** TODO Refactoring of "Potentials" page [6/11]
...
*** TODO Adapt all interfaces to PotentialParameterUI
**** DONE In tremologui.cpp
	 CLOSED: [2014-06-02 Mon 11:11]

**** TODO Outputmeasurement?
*** TODO Debugging [3/9]
...
- [ ] connection for dataChanged() signal
...
**** TODO Rewrite tooltips for buttons
...
Clock summary at [2014-06-04 Wed 18:02], for week 2014-W23.
...
|----------------------------------------------+--------+------|
| Aufgaben                                     | 8:45   |      |
| \__ TODO Refactoring of "Potentials" page... |        | 8:45 |
#+END:
...
| 2014-W23 |     8:45 | -00:15:00 |
|----------+----------+-----------|
| Total    | 41:20:00 |  05:20:00 |
...
6. [ ] virtual void PotentialParameterUI::languageChange() tut überhaupt nichts?? Ist das gewollt?
7. [ ] Underscores for members?
8. [ ] Öffnet man ein neues Projekt, wenn man bei einem vorangegangenen Projekt nicht gesicherte Änderungen hat, dann erscheint zunächst eine Warnung, dass man noch ungesicherte Daten hat. Klickt man auf "Speichern" erscheint dann nochmals eine Warnung für den Potentialstab. Soll ich das ändern? (Eine Möglichkeit wäre evtl. im saveAll slot in tremologui.cpp den savestate des potentialstab auf true zu setzen).
9. [ ] Statt des "save" symbols vielleicht lieber einen Haken oder so?
10. [ ] Sollte es einen Button geben, mit dem man das aktuelle Potentialsfile laden kann? 


* SUMMARY
** Bisher getan:
Resolved some of the linking errors. 
** Was getan werden muss:
1. Resolve linking errors and adapt interfaces. 
2. Implement PotentialParameter_GUI class. Still missing are: 
   - constructor
   - destructor
   - languageChange()
3. Change CMakeFiles.txt file and clean all headers and includes. 
