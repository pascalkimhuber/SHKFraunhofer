...
** TODO Read online tutorial about Qt (signal, slots)
   DEADLINE: <2014-02-01 Sat> SCHEDULED: <2014-01-30 Thu>
...
** TODO Treffen mit Christian am [2014-01-30 Thu]
- [ ] Enable auto-complete in emacs and overall configuration
- [ ] von testing branch ziehen (in separaten lokalen branch testing)
- [ ] branch in gui machen
- [ ] Benutze Tremolo-parser für die Coulom-potentials parameters in der GUI, die können in spme.c gefunden (werden in coulomb.c, CoulombInit aufgerufen). 

*** TODO Aufgabenliste für [2014-01-30 Thu]: [2/4]
1. [X] Qt Tutorial fertig machen
2. [X] Farbe in grep
3. [ ] Branches einrichten
4. [ ] Mit "Arbeit" anfangen
