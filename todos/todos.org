...
* Summary
** Bisher getan:
PotentialParameter_Data durchgegangen. Die wichtigsten Funktionalitäten zusammengefasst. PotentialParameterUI durchgegangen. 
** Was getan werden muss:
1. Mache Übersicht zu PotentialParameterUI (besonders wichtig, was passiert, wenn ich ein Potentials file schreibe, speichere, wann wird es eingelesen).
2. Mache Gesamtübersicht zu PotentialParameterUI - PotentialParameter_Data - TremoloGUI
3. Überlege, wie ich das alles übertragen kann. 
4. Verstehe, für was die PotentialParameter_Data verwendet wird. Und erschließe, ob sie weiterhin benötigt wird, und wie das klappen soll.
