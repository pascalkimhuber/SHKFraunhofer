...
***** TODO Replace Q3GridLayout by QGridLayout

***** TODO Set fixed column width in QGridLayout

***** TODO Change space management in QGridLayout such that rows appear at the same positions. 
