...
** TODO Refactoring of "Potentials" page [1/9]
...
potentialparameterui.cpp        // Derived class from PotentialParameterUISuperClass. Main class for the "Potentials" tab. 
potentialparameterui.h          // Derived class from PotentialParameterUISuperClass. Main class for the "Potentials" tab. 
...
* Summary
** Bisher getan:
Angefangen PotentialParameter_Data zu verstehen. 
** Was getan werden muss:
1. Verstehe den Rest von PotentialParameter_Data (ab toValidatesFileString() in potentialparameter_data.h)
2. Verstehe, für was die PotentialParameter_Data verwendet wird. Und erschließe, ob sie weiterhin benötigt wird, und wie das klappen soll.
3. Gehe PotentialParameterUI durch und kläre, welche Klassen/source files nicht mehr benötigt werden. 
