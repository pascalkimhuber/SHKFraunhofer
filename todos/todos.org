...
** TODO Refactoring of "Potentials" page [4/7]
...
* Arbeitszeit
#+BEGIN: clocktable :maxlevel 2 :scope file :block lastweek
Clock summary at [2014-05-21 Wed 14:27], for week 2014-W20.
...
|----------------------------------------------+---------+-------|
| Aufgaben                                     | 10:32   |       |
| \__ TODO Refactoring of "Potentials" page... |         | 10:32 |
#+END:

#+BEGIN: clocktable :maxlevel 2 :scope file :block thisweek
Clock summary at [2014-05-21 Wed 17:20], for week 2014-W21.
...
|----------------------------------------------+--------+------|
| Aufgaben                                     | 2:40   |      |
| \__ TODO Refactoring of "Potentials" page... |        | 2:40 |
#+END:
...
10. [ ] Frage an Christian: Sollen particles im validates file auch disabled werden können?
...
1. Determine which methods have to be implemented. 
2. Implement PotentialParameter_GUI class.
