...
*** TODO Have a look at the hash-table implementation in tremololo and hash-map implementations in general [2/4]
...
**** TODO Look at code examples from tremolo
The trx_hcreate function is used in the following files (without hash-file):

huber@ram:~/tremolo/src$ grep -ri hashtab.h *
bondforces.c:#include "hash/hashtab.h"
bondforces.h:#include "hash/hashtab.h"
data.h:#include "hash/hashtab.h"
lcforces.c:#include "hash/hashtab.h"
Makefile.am:    $(POLYDIR)/hash/hashtab.h \
Makefile.in:    $(POLYDIR)/hash/hashtab.h $(POLYDIR)/hash/lookupa.c \
...
**** TODO Look at advantages, disadvantages, problems

**** TODO What about parallelization of the code?
...
Clock summary at [2014-10-13 Mon 19:03], for week 2014-W42.
...
|----------------------------------------------+--------+------+------|
| Aufgaben                                     | 2:03   |      |      |
| \__ TODO Add Hessians to tremolo             |        | 2:03 |      |
| \_____ TODO Have a look at the hash-table... |        |      | 2:03 |
#+END:
...
| 2014-W42 |      2:03 | -06:57:00 |
|----------+-----------+-----------|
| Total    | 186:58:00 | -11:02:00 |
