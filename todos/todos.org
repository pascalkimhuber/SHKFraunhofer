...
** TODO Refactoring of "Potentials" page [5/7]
...
Clock summary at [2014-05-14 Wed 18:34], for week 2014-W20.
...
|----------------------------------------------+--------+------|
| Aufgaben                                     | 4:27   |      |
| \__ TODO Refactoring of "Potentials" page... |        | 4:27 |
#+END:
...
1. Decide which methods must be written for PotentialParameter_GUI class. 
2. Make Draft for PotentialParameter_Data class.
3. Implement PotentialParameter_Data class.
4. Implement PotentialParameter_GUI class. 
