...
Clock summary at [2014-05-13 Tue 19:03], for week 2014-W20.
...
|----------------------------------------------+--------+------|
| Aufgaben                                     | 1:37   |      |
| \__ TODO Refactoring of "Potentials" page... |        | 1:37 |
#+END:
...
* Summary
** Bisher getan:
Erster Entwurf für die PotentialParameter_GUI geschrieben (siehe handschriftliche Notizen). 
** Was getan werden muss:
1. Füge connects und slots hinzu
   - innerhalb PotentialParameter_GUI
   - innerhalb PotentialParameter_Data
   - zwischen PotentialParameter_GUI und PotentialParameter_Data
   - zu TremoloGUI
   - zu weiteren Klassen ? 
