...
**
** Created: Thu Jan 30 13:13:08 2014
...
public:
    ...
    void retranslateUi(QDialog *SortDialog)
    {
        ...
        primaryGroupBox->setTitle(QApplication::translate("SortDialog", "&Pimary Key", 0, QApplication::UnicodeUTF8));
